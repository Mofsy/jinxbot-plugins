...
{
    public class ExtraSlowCommandQueue : ICommandQueue
    {
        ...
        {
            // changed from TimedCommandQueue: doubled result
            return (MS_PER_PACKET + (Encoding.UTF8.GetByteCount(message) * MS_PER_BYTE)) * 2;
        }
